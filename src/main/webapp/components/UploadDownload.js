...
export default function CheckboxListSecondary() {
  ...
  //let token = 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJndWVzdEBsYW1pc3BsdXMub3JnIiwiYXV0aCI6IlN1cGVyIEFkbWluIiwibmFtZSI6Ikd1ZXN0IEd1ZXN0IiwiZXhwIjoxNjIyOTIwMjE5fQ.va-Mj3DXyJtlT5VbM98dMfrUHS077THUSOsEZPuSsCfeg0p7GEzOtYkFNT4DfwQNMzGaajek9nySSslaCmMAwA';
  let token = (new URLSearchParams(window.location.search)).get("jwt")
 const url = '/api/'
 //const  url = 'http://localhost:8484/api/'
 //const  url_ndr = 'http://192.168.43.58:8080/'
...
//GET LIST OF NDR GENERATED
 ...
 const  generateAction = () => {
  ...
  //LOOPING THROUGH THE FACILITIES OBJECT ARRAY TO FORM THE NEW OBJECT 
   ...
   axios.post(`${url}ndr_message/generate`, facilitiesApi)
        .then(response => {
          setProcessing(0)
          setDowloadComp(1)
          setGenerateComp(1)
